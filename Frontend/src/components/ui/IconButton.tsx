...
export default function IconButton({
  ...
  return (
    <button
      className={`group relative flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl border border-brand-surface-bright/40 bg-brand-surface-container/60 hover:bg-brand-surface-bright/20 hover:border-brand-surface-bright/80 text-slate-700 dark:text-slate-200 hover:text-slate-900 dark:hover:text-white text-xs font-medium tracking-wider uppercase transition-all duration-300 backdrop-blur-sm active:scale-[0.98] cursor-pointer focus:outline-none ${className}`}
      {...props}
    >
      {icon && (
