...
/**
 * LoginForm Component — Vantage Residential OS
 *
 * Diseño inspirado en la referencia: card glass oscura, inputs pill,
 * social login buttons, fondo limpio dark.
 */
  ...
  return (
    <div className="login-page">
      ...
      <header className="login-branding">
        <h1 className="login-brand-title">Livity</h1>
        <span className="login-brand-subtitle">El control de tu espacio, al instante.</span>
      </header>
      ...
      <div className="login-card">
        <div className="login-card-header">
          ...
          <p className="login-card-description">
            Ingresa tus credenciales para acceder a tu residencia
          </p>
        </div>
