...
export default function UsuarioList() {
  ...
  const columns: Column<Usuario>[] = [
    { 
      header: 'Username', 
      accessor: (row) => <span className="font-bold text-[var(--foreground)]">{row.username}</span>
    },
    { 
      header: 'Email', 
      accessor: 'email'
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold tracking-tight text-[var(--foreground)]">Usuarios</h2>
      ...
      >
        <div className="space-y-4">
          <p className="text-sm text-gray-600 dark:text-gray-400">
            ...
            <strong className="text-[var(--foreground)]">"{selectedUsuario?.username}"</strong>?
          </p>
